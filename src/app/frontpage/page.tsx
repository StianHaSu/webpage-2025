                ...
                <div className="grid grid-cols-1 items-center h-full">
                    ...
                    <div className="row-start-3 flex justify-center">
                        <div className="grid grid-cols-3 gap-12 items-end text-3xl opacity-75 md:text-4xl md:gap-16">
                            <Link href={"https://www.linkedin.com/in/stian-sundkvist"}><i className="fa fa-linkedin" aria-hidden="true"></i></Link>
                            <Link href={"https://github.com/StianHaSu"}><i className="fa fa-github" aria-hidden="true"></i></Link>
                            <Link href={"https://www.instagram.com/szhtian/"}><i className="fa fa-instagram" aria-hidden="true"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
